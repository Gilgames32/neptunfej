...
parser.add_argument("-o", "--output", help="Output file name", default="neptunfej.png")
...
neptunfej(args.text, scale=args.scale, margin=args.margin, reverse=args.reverse).save(args.output)
